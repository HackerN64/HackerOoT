...
void EnExItem_Init(Actor* thisx, PlayState* play) {
    ...
    PRINTF2("\n\n");
    // "What will come out?"
    PRINTF2(VT_FGCOL(GREEN) "☆☆☆☆☆ なにがでるかな？ ☆☆☆☆☆ %d\n" VT_RST, this->type);
    // "What will come out?"
    PRINTF2(VT_FGCOL(YELLOW) "☆☆☆☆☆ なにがでるかな？ ☆☆☆☆☆ %d\n" VT_RST, this->unusedParam);
    ...
    if (this->getItemObjectId >= 0) {
        ...
        if (this->requiredObjectSlot < 0) {
            ...
            PRINTF2("なにみの？ %d\n", this->actor.params);
            // "bank is funny"
            PRINTF2(VT_FGCOL(MAGENTA) " バンクおかしいしぞ！%d\n" VT_RST "\n", this->actor.params);
            return;
        }
...
void EnExItem_WaitForObject(EnExItem* this, PlayState* play) {
    ...
    if (Object_IsLoaded(&play->objectCtx, this->requiredObjectSlot)) {
        // "End of transfer"
        PRINTF2(VT_FGCOL(GREEN) "☆☆☆☆☆ 転送終了 ☆☆☆☆☆ %d\n" VT_RST, this->actor.params, this);
        PRINTF2(VT_FGCOL(YELLOW) "☆☆☆☆☆ 転送終了 ☆☆☆☆☆ %d\n" VT_RST, this->actor.params, this);
        PRINTF2(VT_FGCOL(BLUE) "☆☆☆☆☆ 転送終了 ☆☆☆☆☆ %d\n" VT_RST, this->actor.params, this);
        PRINTF2(VT_FGCOL(MAGENTA) "☆☆☆☆☆ 転送終了 ☆☆☆☆☆ %d\n" VT_RST, this->actor.params, this);
        PRINTF2(VT_FGCOL(CYAN) "☆☆☆☆☆ 転送終了 ☆☆☆☆☆ %d\n\n" VT_RST, this->actor.params, this);
