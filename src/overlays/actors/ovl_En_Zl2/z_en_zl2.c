        ...
        if (nextCueId != currentCueId) {
            switch (nextCueId) {
                ...
                case 15:
                    ...
                    break;
                default:
                    PRINTF2("En_Zl2_inAgain_Check_DemoMode:そんな動作は無い!!!!!!!!\n");
            }
        ...
        if (nextCueId != currentCueId) {
            switch (nextCueId) {
                ...
                case 21:
                    ...
                    break;
                default:
                    PRINTF2("En_Zl2_inEnding_Check_DemoMode:そんな動作は無い!!!!!!!!\n");
            }
            this->cueId = nextCueId;
        }
    }
        ...
        if (nextCueId != currentCueId) {
            switch (nextCueId) {
                ...
                case 14:
                    ...
                    break;
                default:
                    PRINTF2("En_Zl2_inRunning_Check_DemoMode:そんな動作は無い!!!!!!!!\n");
                    break;
            }
            this->cueId = nextCueId;
        }
...
#endif
        default:
            PRINTF2(VT_FGCOL(RED) " En_Oa2 の arg_data がおかしい!!!!!!!!!!!!!!!!!!!!!!!!!\n" VT_RST);
            func_80B4FD90(this, play);
    }
}
...
#if IS_DEBUG
    if (objectSlot < 0) {
        PRINTF2(VT_FGCOL(RED) "En_Zl2_main_bankアニメーションのバンクを読めない!!!!!!!!!!!!\n" VT_RST);
        return;
    }
#endif
