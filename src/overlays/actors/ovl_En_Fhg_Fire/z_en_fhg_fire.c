...
void EnFhgFire_Init(Actor* thisx, PlayState* play) {
    ...
    if (this->actor.params == FHGFIRE_LIGHTNING_SHOCK) {
        ...
        PRINTF2("yari hikari ct 1\n"); // "light spear"
        EnFhgFire_SetUpdate(this, EnFhgFire_SpearLight);
        PRINTF2("yari hikari ct 2\n");
