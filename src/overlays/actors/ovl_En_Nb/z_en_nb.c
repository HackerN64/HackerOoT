...
void EnNb_UpdatePath(EnNb* this, PlayState* play) {
    ...
    if (pathList != NULL) {
        ...
        PRINTF2("En_Nb_Get_path_info レールデータをゲットだぜ = %d!!!!!!!!!!!!!!\n", path);
    } else {
        // "En_Nb_Get_path_info Rail Data Doesn't Exist!!!!!!!!!!!!!!!!!!!!"
        PRINTF2("En_Nb_Get_path_info レールデータが無い!!!!!!!!!!!!!!!!!!!!\n");
    }
}
        ...
        if (nextCueId != currentCueId) {
            switch (nextCueId) {
                ...
                default:
                    ...
                    PRINTF2("En_Nb_Kidnap_Check_DemoMode:そんな動作は無い!!!!!!!!\n");
                    break;
            }
        ...
        if (nextCueId != currentCueId) {
            switch (nextCueId) {
                ...
                default:
                    ...
                    PRINTF2("En_Nb_Confrontion_Check_DemoMode:そんな動作は無い!!!!!!!!\n");
                    break;
            }
            this->cueId = nextCueId;
        }
        ...
        if (nextCueId != currentCueId) {
            switch (nextCueId) {
                ...
                default:
                    ...
                    PRINTF2("En_Nb_inEnding_Check_DemoMode:そんな動作は無い!!!!!!!!\n");
                    break;
            }
            this->cueId = nextCueId;
        }
