...
#if IS_DEBUG_BOOT_ENABLED && (defined PACKAGE_AUTHOR)
const char* gBuildAuthor = EXPAND_AND_STRINGIFY(PACKAGE_AUTHOR);
#else
const char* gBuildAuthor = "???";
#endif

#if IS_DEBUG_BOOT_ENABLED && (defined PACKAGE_COMMIT_AUTHOR)
...
#if IS_DEBUG_BOOT_ENABLED && (defined PACKAGE_VERSION)
const char* gBuildGitVersion = EXPAND_AND_STRINGIFY(PACKAGE_VERSION);
#else
const char* gBuildGitVersion = "???";
#endif

#if IS_DEBUG_BOOT_ENABLED && (defined PACKAGE_NAME)
