...
static s16 sBtnPosXShifts[] = { WIDE_BTNB_SHIFT, (WIDE_CLEFT_SHIFT / 4), (WIDE_CDOWN_SHIFT / 4), (WIDE_CRIGHT_SHIFT / 4), 0 };
    ...
    if (gSaveContext.save.info.playerData.magicLevel != 0) {
        ...
        if (gSaveContext.magicState == MAGIC_STATE_METER_FLASH_2) {
            ...
            // TODO: find something better
            {
                ...
                s16 posRx = WIDE_MULT(WIDE_INCR((R_MAGIC_FILL_X + gSaveContext.save.info.playerData.magic), 1), WIDE_GET_RATIO);
...
void Interface_Draw(PlayState* play) {
    ...
    if (pauseCtx->debugState == 0) {
        ...
        if (!(interfaceCtx->unk_1FA)) {
            ...
            gSPTextureRectangle(OVERLAY_DISP++, WIDE_INCR(R_B_LABEL_X(gSaveContext.language), 1 + sBtnPosXShifts[0]) << 2,
