...
void Attention_Draw(Attention* attention, PlayState* play) {
    ...
    if (GET_PLAYER(play)->stateFlags3 & PLAYER_STATE3_ACTOR_CS_HALT) {
        return;
    }
#endif
...
ActorFreezeMasks sCategoryFreezeMasks[ACTORCAT_MAX] = {
    ...
    { PLAYER_STATE1_TALKING | PLAYER_STATE1_DEAD | PLAYER_STATE1_28, 0 , PLAYER_STATE3_ACTOR_CS_HALT },
    // ACTORCAT_PLAYER
    { 0, 0, PLAYER_STATE3_ACTOR_CS_HALT },
    // ACTORCAT_EXPLOSIVE
    ...
    // ACTORCAT_ENEMY
    { PLAYER_STATE1_TALKING | PLAYER_STATE1_DEAD | PLAYER_STATE1_28 | PLAYER_STATE1_29, 0, PLAYER_STATE3_ACTOR_CS_HALT },
    // ACTORCAT_PROP
