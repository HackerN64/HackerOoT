...
typedef enum {
    ...
    CS_STATE_SKIPPABLE_INIT,    // CS_STATE_START
    CS_STATE_SKIPPABLE_EXEC,    // CS_STATE_RUN
    CS_STATE_UNSKIPPABLE_INIT,  // CS_STATE_STOP
    CS_STATE_UNSKIPPABLE_EXEC   // CS_STATE_RUN_UNSKIPPABLE
} CutsceneState;
