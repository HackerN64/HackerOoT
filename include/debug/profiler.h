#ifndef HACKEROOT_PROFILER_H
#define HACKEROOT_PROFILER_H

#include "config.h"
#include "z64.h"

// from https://github.com/HackerN64/F3DEX3/blob/b4d5e8193d06e4e4227a056366d9d75f48765d96/cpu/counters.c
...
typedef enum ProfilingMode {
    /* 0 */ PROFILING_MODE_DEFAULT,
    /* 1 */ PROFILING_MODE_A,
    /* 2 */ PROFILING_MODE_B,
    /* 3 */ PROFILING_MODE_C,
    /* 4 */ PROFILING_MODE_MAX
} ProfilingMode;
